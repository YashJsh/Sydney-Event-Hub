...
const func = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield page.goto("https://www.sydney.com/events", {
    ...
    const events = yield page.evaluate(() => {
        ...
        return Array.from(eventElements).map((e) => {
            ...
            const title = ((_a = e.querySelector(".tile__product-list-tile-heading h3")) === null || _a === void 0 ? void 0 : _a.textContent) ||
                "Untitled";
            ...
            const link = (_d = e.querySelector(".tile__product-list-link")) === null || _d === void 0 ? void 0 : _d.getAttribute("href");
            ...
            const price = ((_o = (_m = e.querySelector(".tile__product-rate-from span")) === null || _m === void 0 ? void 0 : _m.textContent) === null || _o === void 0 ? void 0 : _o.trim()) ||
                null;
            return {
                title,
                description,
